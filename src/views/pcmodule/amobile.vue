    ...
    <div class="mobile">
        ...
        <div class="unit unit8">
            <div class="top">
                ...
                <div class="img"><img src="~@/assets/img/PCimg/item1-ddd.png" alt=""></div>
                <div class="text"><span>注册申请成为A·PAY项目方代理，为服务对象开通商户账号使用API为商户嵌入支付系统，即可完成接入</span></div>
            </div>
            <div class="bottom">
                <i></i>
            </div>
...
export default {
  ...
  methods: {
    ...
    submit () {
      ...
      this.$post(this.$api.website +'/api/agency/apply', data).then(res => {
          if (res.code === 0) {
            Message({
              message: res.data,
              type: "success"
